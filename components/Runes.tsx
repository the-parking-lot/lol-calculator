...
const Runes = () => {
    return (
        <Box bg={useColorModeValue('gray.200', 'gray.700')} p={4} minW={500} w="95%" borderRadius={5} alignItems={"center"} textAlign={"center"} >
            <Heading size="lg">Runes</Heading>
            <Flex w="100%" h={675} my={2} direction={"row"}>
